package calendar.event.reminder.Activity
...
import calendar.event.reminder.ConnectionDetector
import calendar.event.reminder.Extensions.*
import calendar.event.reminder.Fragment.*
import calendar.event.reminder.Fragment.Home.HomeFragment
import calendar.event.reminder.Model.Event
import calendar.event.reminder.Model.EventType
import calendar.event.reminder.R
import calendar.event.reminder.SharedPrefrences
import calendar.event.reminder.databinding.ActivityMainBinding
import calendar.event.reminder.dialogs.SetRemindersDialog
