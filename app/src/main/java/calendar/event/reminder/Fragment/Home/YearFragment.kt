...
import calendar.event.reminder.Extensions.getViewBitmap
import calendar.event.reminder.Extensions.printBitmap
import calendar.event.reminder.Model.DayYearly
import calendar.event.reminder.R
import calendar.event.reminder.databinding.FragmentYearBinding
import calendar.event.reminder.helpers.MONTHLY_VIEW
import calendar.event.reminder.helpers.YEAR_LABEL
import calendar.event.reminder.helpers.YearlyCalendarImpl
import calendar.event.reminder.interfaces.YearlyCalendar
import calendar.event.reminder.views.SmallMonthView
