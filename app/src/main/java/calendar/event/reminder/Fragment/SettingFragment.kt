package calendar.event.reminder.Fragment
...
import calendar.event.reminder.Activity.PolicyActivity
import calendar.event.reminder.BuildConfig
import calendar.event.reminder.Extensions.calDAVHelper
import calendar.event.reminder.Extensions.config
import calendar.event.reminder.Extensions.eventTypesDB
import calendar.event.reminder.R
import calendar.event.reminder.databinding.FragmentSettingBinding
import calendar.event.reminder.services.AlarmReceiver
        ...
        fragmentSetting?.icCustomIcons?.setOnClickListener {
            requireActivity().packageManager.setComponentEnabledSetting(
                ComponentName(
                    ...
                    "calendar.event.reminder.DefaultLauncher"
                ),
